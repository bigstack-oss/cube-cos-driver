...
func main() {
	...
	enterpriseDir := flag.String("enterprise-dir", envOr("ENTERPRISE_DIR", ""), "folder holding App-Framework + CubeCMP + Advisor install images (may be a mounted USB/virtual media); empty = <data-dir>/enterprise; UI-overridable")
